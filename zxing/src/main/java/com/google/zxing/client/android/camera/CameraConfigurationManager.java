...
final class CameraConfigurationManager {
     ...
     */
    void initFromCameraParameters(OpenCamera camera, Rect frameRect) {
     ...
     */
        ...
        //如果显示画面的大小尺寸获取到了，则用这个，否则用默认。解决不居中的问题
        if (frameRect != null) {
            theScreenResolution.set(Math.abs(frameRect.right), Math.abs(frameRect.bottom));
        } else {
