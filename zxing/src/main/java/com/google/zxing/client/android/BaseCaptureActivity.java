...
public abstract class BaseCaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private AnimViewCallback viewCallback;
    private Collection<BarcodeFormat> decodeFormats;
    private Map<DecodeHintType, ?> decodeHints;
    private String characterSet;
    private IntentSource source;

    public AnimViewCallback getViewfinderView() {
        return viewCallback;
    }
    ...
    private void decodeOrStoreSavedBitmap(Bitmap bitmap, Result result) {
        ...
        if (handler != null && result != null) {
            Message.obtain(handler, Ids.decode_succeeded, result).sendToTarget();
        } else {
...
//            beepManager.playBeepSoundAndVibrate();
    ...
    public void reScan() {
        if (hasSurface) {
            ...
            if (handler != null) {
                Message.obtain(handler, Ids.restart_preview).sendToTarget();
            }
        }
    }
